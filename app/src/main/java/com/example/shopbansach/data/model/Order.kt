...
data class Order(
    ...
    @get:PropertyName("shippingAddress") @set:PropertyName("shippingAddress")
    ...
    @get:PropertyName("sellerIds") @set:PropertyName("sellerIds")
    var sellerIds: List<String> = emptyList(), // Danh sách các shop ID có trong đơn này
